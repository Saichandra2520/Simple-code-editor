/* PrismJS 1.29.0
https://prismjs.com/download.html#themes=prism-okaidia&languages=markup+css+clike+javascript+c+cpp+css-extras+java+python+jsx+tsx+typescript&plugins=show-language+inline-color+toolbar+copy-to-clipboard */
var _self =
